...
async function ensureSchemas() {
    try {
        ...
        try {
            await db.execute("ALTER TABLE image_colors ADD COLUMN variant VARCHAR(20) NOT NULL DEFAULT 'global'");
        } catch (e) {}
        try {
            await db.execute("CREATE INDEX idx_image_colors_image_variant ON image_colors (image_id, variant)");
        } catch (e) {}
    } catch (e) {
